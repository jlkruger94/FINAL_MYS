...
HD_PWD='E:/Especializacion_fiuba/MyS/TP_FINAL/sintesis/TP_FINAL/TP_FINAL.runs/system_fir_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fir_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fir_ip_0_0.tcl
